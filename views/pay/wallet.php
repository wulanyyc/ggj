...
<div class="card" id="suc" style="background: url('http://img.guoguojia.vip/img/payok_new.jpeg') no-repeat;background-size: 100% 100%;">
  <div style="position: absolute; bottom: 30px;width: 100%;">
    <div style="display: flex;flex-direction: column;justify-content: center;align-items: center;padding: 10px;margin:20px;display: -webkit-flex;flex-direction: -webkit-column;justify-content: -webkit-center;align-items: -webkit-center;">
