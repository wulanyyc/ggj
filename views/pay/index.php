...
<div class="card" id="suc" style="background: url('http://img.guoguojia.vip/img/payok_new.jpeg') no-repeat;background-size: 100% 100%;">
  <div style="position: absolute; bottom: 30px;width: 100%;">
    <div style="display: flex;flex-direction: column;justify-content: center;align-items: center;display: -webkit-flex;flex-direction: -webkit-column;justify-content: -webkit-center;align-items: -webkit-center;padding: 10px;margin:20px;">
...
<?php } else { ?>
<div class="card" id="fail" style="display: flex;flex-direction: column;justify-content: center;align-items: center;display: -webkit-flex;flex-direction: -webkit-column;justify-content: -webkit-center;align-items: -webkit-center;">
  <div style="display: flex;flex-direction: row;justify-content: center;align-items: center;display: -webkit-flex;flex-direction: -webkit-row;justify-content: -webkit-center;align-items: -webkit-center;width:300px;margin-top:50px;margin-bottom: 30px;">
    <img src="/img/cry.png" />
