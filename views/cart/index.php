...
<div class="card" id="address_info">
  ...
  <form id="address_form" name='address_form' style='margin:5%;'>
    ...
    <div class='form-group' style='margin-top:10px;padding-bottom:10px;display: flex;flex-direction: row;justify-content: flex-start;' id="label_add_group">
...
<div class="card" id="express_info">
  ...
  <div style="padding: 5%;">
    ...
    <p style="display: flex;flex-direction: row;justify-content: flex-start;margin-top: 5px;">
      ...
      <span style="width:72%;">每周2、4、6上午发货。<br/>取最近的时间发货</span>
    </p>
    <p style="display: flex;flex-direction: row;justify-content: flex-start;margin-top: 5px;">
