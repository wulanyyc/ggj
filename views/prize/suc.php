...
<div style="display: table;width: 100%;height: 100%;background-color: #f5f5f5;">
    ...
    <div style="display: table-row;text-align: center;vertical-align: middle;margin-top:10px;">
        <div>恭喜您获得</div>
        <div style="color:red;"><?=$text ?>, <?=$day ?>天后可继续抽奖</div>
    </div>

    <div style="display: table-row;text-align: center;vertical-align: middle;margin-top:10px;">
        <div style="width: 80%;margin-left: 10%;">优惠券：在购买中直接减免订单金额</div>
        <div style="width: 80%;margin-left: 10%;margin-top:5px;">水果礼品：<span style="color:red;">可在平台任何支付完成订单中领取，并随该订单一起发货</span></div>
    </div>
