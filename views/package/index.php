      ...
      <div id="rule" style="margin-top: 1%;">
        <ul>
          ...
          <li>
            ...
            <div>
            根据时令动态调整，目前支持12种水果, 如有特殊需求请<a href="/contact">联系我们</a>
            </div>
          </li>
          ...
          <li>
            ...
            <div>
            为保持水果新鲜度，仅接受<span style="color:red;font-weight: bold;">大成都</span>地区的预约订单，且<span style="color:red;font-weight: bold;">周三、周六</span>可发货，后期可增加进/发货日
            </div>
          </li>
          ...
          <li>
            ...
            <div>
              价格享平台价的9折，预约订单金额需满69元，免运费，少于则加收6元快递费，金额不低于49元
            </div>
          </li>
