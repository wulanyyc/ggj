...
<div class="card" id="type_content" style="display: flex;align-items: center;justify-content: center;">
      ...
      <div id="rule" style="margin-top: 1%;font-size: 14px;width:100%;">
        <ul>
          ...
          <li>
            ...
            <div>
            限成都，每周<span style="color:red;font-weight: bold;">1、3、5</span>发货，隔日达
            </div>
          </li>
        </ul>
        <hr/>
    ...
    <br/>
    <div style="display: flex;flex-direction: row;justify-content: space-around;width:100%;margin-top:1%;">
