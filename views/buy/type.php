...
<div id="type_content">
    ...
    <br/>
    <a class="btn btn-success" href="/buy/booking?id=<?=$id ?>" style="width: 50%;margin-left:25%;margin-top:20px;">去预约</a>
    <br/>
    <a class="btn btn-danger" href="/buy/?id=<?=$id ?>" style="width: 50%;margin-left:25%;margin-top:20px;">买现货</a>
</div>
