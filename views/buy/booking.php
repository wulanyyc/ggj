...
<div style="position: fixed;top: 55px;width:100%;">
    <div class="card">
      <div class="card-header bg-white" style="color: #866D8D;position:relative;border-radius: 0;border-bottom: 2px solid #866D8D;display: -webkit-flex;flex-direction: -webkit-row;justify-content: -webkit-space-between;align-items: -webkit-center;display: flex;flex-direction: row;justify-content: space-between;align-items: center;">
        预约商品
...
<div id="tongji">
  ...
  <div id="tips" style="color:#aaa;margin-left: 5px;margin-right: 3px;font-size: 14px;">满<?=$buyGod ?>包邮</div>
  ...
  <div class='btn btn-secondary' id='order' style="margin-right: 8px;width:90px;"><?=$buyLimit ?>元起购</div>
</div>
...
<div class="card" id="login">
  ...
  <div style="width:94%;margin: 10px auto;" id="login_form">
    ...
    <div style="display: -webkit-flex;flex-direction: row;justify-content: -webkit-flex-start;display: flex;flex-direction: row;justify-content: flex-start;margin-bottom: 10px;">
