              ...
              <div class="product-content">
                ...
                <div class="product-desc" style="width: 58%;">
                  ...
                  <div class="inventory">
                    ...
                    &nbsp;&nbsp;每单限<?=$product['buy_limit'] ?><?=$product['unit'] ?>
                    <?php } ?>
                  </div>
                </div>
              </div>
...
<div class="card" id="login">
  ...
  <form style="width:94%;margin: 10px auto;" id="login_form" onsubmit="false">
...
<!--     <div style="margin-bottom: 10px;">
      <textarea id="receiver_memo" name="receiver_memo" style="width: 100%;border: 1px solid #ced4da;padding: 5px 10px;" placeholder="其它要求"></textarea>
    </div> -->

<!--     <div style="margin-bottom: 10px;">
      <select name='express_rule' id="search_status" style='width:100%;border: 1px solid #ced4da;height: 30px'>
