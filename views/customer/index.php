...
<?php if (!$isWechat) { ?>
<button type="button" class="btn btn-danger" id="quit" style="width:80%;margin-left: 10%;margin-top: 18px;">退出</button>
<?php } else { ?>
<a class="btn btn-danger" href="/site" style="width:80%;margin-left: 10%;margin-top: 18px;text-decoration: none;">逛商城</a>
<?php } ?>
